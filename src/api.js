...
function getToken() {
  ...
  if (!accessToken) {
    ...
    if (!code) {
      window.location.href = 'https://secure.meetup.com/oauth2/authorize?client_id=k9vf6q35i0rb8af51v9cjaat2b&response_type=code&redirect_uri=https://teresasanders77.github.io/meetup/';
      return null;
    }
